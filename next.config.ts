...
const securityHeaders = [
  {
    ...
    value: [
      ...
      "img-src 'self' blob: data: https://*.stripecdn.com https://lacassonaise.fr https://pay.google.com https://www.gstatic.com https://*.stripe.com https://*.tile.openstreetmap.org https://www.openstreetmap.org",
      "font-src 'self' https://fonts.gstatic.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
      "frame-ancestors 'none'",
      "frame-src https://js.stripe.com https://hooks.stripe.com https://*.hcaptcha.com https://newassets.hcaptcha.com https://pay.google.com https://www.openstreetmap.org",
